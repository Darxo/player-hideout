::mods_hookExactClass("entity/world/location", function(o) {
	...
	o.onCombatLost = function()
	{
        ...
        foreach (entity in entities)
        {
            ...
            entity.m.OnEnter = "event.setup_hideout";   // OnEnter is only called when you enter an unVisited location. So we need this but it is also not enough for our purpose
